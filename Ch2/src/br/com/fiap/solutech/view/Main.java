			...
			try {
				...
				while(n == 0) {
					...
					if(check) {
					        ...
					        String rg = JOptionPane.showInputDialog("Digite o seu rg: (Sem caracteres especiais) ");
					        String cpf = JOptionPane.showInputDialog("Digite o seu cpf: (Sem caracteres especiais)");
